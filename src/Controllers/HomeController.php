            ...
            $welcome = new Panel(
                ...
                row1: [
                    $bio = new View(
                        ...
                        element2: $bioCaption = '<p>Brigadier General Houston R. Cantwell<br><em>Commander, Holm Center </em>&nbsp;</p><br><p><a href="https://www.af.mil/About-Us/Biographies/Display/Article/2298672/houston-r-cantwell/" target="_blank" rel="noopener" style="color: #0087ff">Biography</a></p>',
                    ), 
                    new View(

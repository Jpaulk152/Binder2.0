...
//#########################################################################################
    ...
    public $container = "sideContent primaryBackground w3-container w3-sidebar w3-border w3-bar-block w3-collapse w3-animate-left w3-card";
    // public $sbContainerClasses = "sideContent primaryBackground w3-container w3-sidebar w3-border w3-bar-block w3-animate-left w3-card";
    public $button = "sideButton secondaryBackground w3-button w3-block w3-border w3-card-4";
    public $anchor = "w3-bar-item";

    public $anchorContainer = "w3-hide w3-animate-zoom w3-animate-top";
    public $subContainer = "primaryBackground w3-hide w3-animate-zoom accordian";
    public $caret = "fa fa-caret-right caret";
    // public $sbCloseBtnClasses = "w3-bar-item w3-button w3-hide-large";
    // public $sbOpenBtnClasses = "w3-button w3-xlarge w3-hide-large";
